...
const questionGenerator = () => {
  ...
  submitBtn.addEventListener("click", () => {
    ...
    //If user input is empty
      ...
      errorMessage.classList.remove("hide");
      errorMessage.innerHTML = "Please enter a valid operator OR number";
    }
  });
};
...
//Stop Game
const stopGame = (isCorrect) => {
  let resultText = isCorrect ? "Great!! Correct Answer" : "Try again! Wrong Answer";
  alert(resultText);
  questionGenerator();
};
